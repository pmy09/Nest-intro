...
var generateAuthToken_1 = require("../../../../../../../../../src/helpers/generateAuthToken");
var hashPassword_1 = require("../../../../../../../../../src/helpers/hashPassword");
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.createUser = function (createUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, existsUser, newUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = createUserDto.email, password = createUserDto.password;
                        return [4 /*yield*/, this.userRepository.findOneBy({ email: email })];
                    case 1:
                        existsUser = _a.sent();
                        ...
                        createUserDto.password = (0, hashPassword_1.hashPassword)(password);
                        newUser = this.userRepository.create(createUserDto);
                        this.userRepository.save(newUser);
                        return [2 /*return*/, 'User successfully created'];
                }
            });
        });
    };
    ...
    UsersService.prototype.getSingleUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, generateAuthToken_1.generateAuthToken)(user.id)];
                    case 3:
                        token = _a.sent();
                        return [2 /*return*/, {
                                token: token,
